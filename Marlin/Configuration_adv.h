...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 100 //undefined at 500 by default. enabled and set to 100
   ...
   */
  #define BLTOUCH_HS_MODE true //turning on high speed mode
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #if HAS_BED_PROBE
    #define PROBE_OFFSET_WIZARD //this is off by default. 
      ...
      //
      #define PROBE_OFFSET_WIZARD_START_Z 0 //default is -4.0

      // Set a convenient position to do the calibration (probing point and nozzle/bed-distance)
      #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER, Y_CENTER } //this was off by default
    #endif
  #endif
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MILLIMETER_UNITS       // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps. This is off by default. 
  #define BABYSTEP_MULTIPLICATOR_Z  0.01       // (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY 1       // (steps or mm) Steps or millimeter distance for each XY babystep

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping. This is off by default. 
